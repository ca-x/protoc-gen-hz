...
func (pkgGen *HTTPPackageGenerator) generateHandlerCode(service *Service, method *HTTPMethod) string {
    return `// Code generated by protoc-gen-hz. DO NOT EDIT.
...
func ` + method.Name + `(ctx context.Context, c *app.RequestContext) {
    var err error
    var req model.` + method.RequestType + `
    ...
    resp := &model.` + method.ResponseType + `{}
    c.JSON(200, resp)
}
`
}
...
func (pkgGen *HTTPPackageGenerator) generateRouterCode(httpPkg *HTTPPackage) string {
    code := `// Code generated by protoc-gen-hz. DO NOT EDIT.
